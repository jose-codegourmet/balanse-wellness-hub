...
- [ ] Keyboard + Storybook a11y — run `pnpm --filter admin test-storybook` before you ship admin work (the static `pnpm build-storybook` does not execute axe; CI enforcement is a follow-up)
