...
Session packages (fixed session entitlements, including a free Newbie Package) are delivered as mock-first catalogue + ledger UI plus BE-058 contracts. See `openspec/specs/session-bundles.md` and GitHub #290. Screens do not call `/api/*` yet.
- promo codes
- loyalty
