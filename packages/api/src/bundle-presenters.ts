...
import {
  ...
  type HttpBundleAcquisition,
  type HttpBundleRedemption,
  type HttpCustomerEntitlement,
  type PublicPackage,
} from "@balanse/domain";
...
export function presentEntitlement(row: EntitlementRow): HttpCustomerEntitlement {
