...
import { BrandLockup, Button, Input, Label, LocalizedSkeleton, MarketingImage } from "@balanse/ui";
  ...
  return (
    <section className="auth-login-shell">
      <aside className="auth-login-aside">
        ...
        />
        <div className="auth-login-aside-copy">
          <p className="auth-login-kicker">A little space for yourself</p>
          <p className="auth-login-quote">Come back to your practice, your rhythm, your people.</p>
          <span className="auth-login-aside-rule" aria-hidden="true" />
          <p className="auth-login-location">Balansé Wellness Hub · Cebu City</p>
        </div>
      </aside>
      ...
      <div className="auth-login-panel">
        ...
        <div className="auth-login-heading">
          <p className="auth-login-kicker">Member access</p>
          <h1>Welcome back</h1>
