...
/**
 * The single entry point for admin toasts (FE-ADM-019). Screens call this
...
export const notify = {
  ...
  /** Raises one of the reviewed `@balanse/domain` admin messages. */
  admin: (id: AdminToastId, overrides?: Pick<NotifyInput, "id" | "timeout">) => {
    const copy = adminToastCopy(id);
